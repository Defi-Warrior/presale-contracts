...
//   busd = await StableCoin.deployed();
    ...
    await deployer.deploy(Setting, "Private Sale Phase 1", block.number + 1, 0, 1000, expandTo18Decimals(100), expandTo18Decimals(100000000), 2, 12);
    privateSetting_1 = await Setting.deployed();

    await deployer.deploy(Setting, "Private Sale Phase 2", block.number + 1, 0, 909, expandTo18Decimals(100), expandTo18Decimals(150000000), 2, 12);
    privateSetting_2 = await Setting.deployed();

    await deployer.deploy(Setting, "Private Sale Phase 3", block.number + 1, 0, 833, expandTo18Decimals(100), expandTo18Decimals(200000000), 2, 12);
    privateSetting_3 = await Setting.deployed();

    await deployer.deploy(Setting, "Private Sale Phase 4", block.number + 1, 0, 769, expandTo18Decimals(100), expandTo18Decimals(250000000), 2, 12);
